...
<div class="container-fluid">
    ...
    <div class="row mb-3">
        <div class="col-md-12 text-end">
            <a href="{{ route('clustering.export', ['cluster' => $cluster->id, 'format' => 'xlsx']) }}" class="btn btn-success">Export XLSX</a>
            <a href="{{ route('clustering.export', ['cluster' => $cluster->id, 'format' => 'csv']) }}" class="btn btn-outline-secondary">Export CSV</a>
            <a href="{{ route('clustering.pdf', $cluster->id) }}" class="btn btn-outline-dark">Download PDF</a>
            <a href="{{ route('clustering.rerun', $cluster->id) }}" class="btn btn-warning">Rerun Analisis (simpan params)</a>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    @endphp
                    <p><strong>Fitur:</strong> {{ implode(', ', $params['features'] ?? ['recency','frequency','monetary']) }}</p>
