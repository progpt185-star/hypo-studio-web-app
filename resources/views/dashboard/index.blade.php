...
@section('title', 'Dashboard - Hypo Studio')
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="mb-0 text-primary">{{ $totalCustomers }}</h2>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="mb-0 text-warning">{{ $totalClusters }}</h2>
                        </div>
    ...
    <div class="row mt-4">
        <div class="col-md-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <a href="{{ route('customers.index') }}" class="btn btn-outline-primary me-2 mb-2">
                        <i class="fas fa-users"></i> Kelola Pelanggan
                    </a>
                    <a href="{{ route('orders.index') }}" class="btn btn-outline-success me-2 mb-2">
                        <i class="fas fa-shopping-cart"></i> Kelola Pesanan
                    </a>
                    <a href="{{ url('/clustering') }}" class="btn btn-outline-warning me-2 mb-2">
                        <i class="fas fa-network-wired"></i> Analisis K-Means
                    </a>
                    <a href="{{ url('/clustering/history') }}" class="btn btn-outline-info mb-2">
...
<script>
    ...
    new Chart(orderCtx, {
        type: 'bar',
        data: {
            labels: @json($ordersByMonth['labels']),
            datasets: [{
                label: 'Jumlah Pesanan',
                data: @json($ordersByMonth['data']),
    ...
    new Chart(clusterCtx, {
        type: 'doughnut',
        data: {
            labels: @json($customersByCluster['labels']),
            datasets: [{
                data: @json($customersByCluster['data']),
                backgroundColor: [
