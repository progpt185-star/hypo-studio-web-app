<?php $__env->startSection('title', (isset($order) ? 'Edit' : 'Tambah') . ' Pesanan - Hypo Studio'); ?>
...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-12">
            ...
            <h1 class="h3 mb-0">
                <i class="fas fa-<?php echo e(isset($order) ? 'edit' : 'plus'); ?>"></i>
                <?php echo e(isset($order) ? 'Edit' : 'Tambah'); ?> Pesanan
            </h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <form action="<?php echo e(isset($order) ? route('orders.update', $order) : route('orders.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php if(isset($order)): ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('order_date', isset($order) ? $order->order_date->format('Y-m-d') : '')); ?>" required>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\asoy9\OneDrive\Documents\GitHub\hypo-studio-web-app\resources\views/orders/create.blade.php ENDPATH**/ ?>